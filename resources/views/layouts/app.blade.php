            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                                    ...
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                ...
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Mobile Phones</a></li>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+91)1800-245-245 </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>562 Gandhi Marg, Delhi
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>(+91)1800-245-245
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@bigmart.in
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <!-- <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Bigmart</strong> All rights reserved
                    </p> -->
                </div>
            </div>
        </div>
